...
from model import Model    #Importamos la clase model desde la version con pesos: modelW
#from process import Process
#from simulator import Simulator
from simulation import Simulation      #Importamos la clase Simulation desde la version con pesos: simulationW
